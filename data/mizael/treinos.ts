...
export const MIZAEL_TREINOS: Treino[] = [
  {
    ...
    exercises: [
      { name: "Supino com halteres (no chão)", sets: 3, reps: "10-12", restSeconds: 120, initialWeightKg: 7, notes: "6-8 kg cada — descer em 2-3 seg" },
      { name: "Desenvolvimento de ombro sentado", sets: 3, reps: "10-12", restSeconds: 120, initialWeightKg: 5.5, notes: "5-6 kg cada" },
      { name: "Supino inclinado com halteres", sets: 3, reps: "10-12", restSeconds: 120, initialWeightKg: 7, notes: "6-8 kg cada" },
      { name: "Elevação lateral (ombro)", sets: 3, reps: "12-15", restSeconds: 90, initialWeightKg: 4.5, notes: "4-5 kg cada" },
      { name: "Tríceps na polia", sets: 3, reps: "12-15", restSeconds: 90, initialWeightKg: 0, notes: "Ajustar conforme capacidade" },
  ...
  },
  {
    ...
    exercises: [
      { name: "Agachamento com barra", sets: 4, reps: "8-10", restSeconds: 120, initialWeightKg: 20, notes: "Barra vazia (20kg) — priorizar técnica" },
      ...
      { name: "Avanço com halteres", sets: 3, reps: "10 cada perna", restSeconds: 120, initialWeightKg: 7, notes: "6-8 kg cada" },
  ...
  },
  {
    ...
    exercises: [
      { name: "Puxada na polia (barra larga)", sets: 4, reps: "10-12", restSeconds: 120, initialWeightKg: 0, notes: "Ajustar" },
      { name: "Remada com halter apoiado", sets: 3, reps: "10-12", restSeconds: 120, initialWeightKg: 11, notes: "10-12 kg cada" },
      { name: "Remada na polia baixa", sets: 3, reps: "10-12", restSeconds: 120, initialWeightKg: 0, notes: "Ajustar" },
      { name: "Rosca bíceps com halteres", sets: 3, reps: "10-12", restSeconds: 90, initialWeightKg: 7.5, notes: "7-8 kg cada" },
      { name: "Rosca martelo", sets: 3, reps: "10-12", restSeconds: 90, initialWeightKg: 7.5, notes: "7-8 kg cada" },
  ...
  },
  {
    ...
    exercises: [
      { name: "Stiff com halteres (posterior)", sets: 4, reps: "10-12", restSeconds: 120, initialWeightKg: 11, notes: "10-12 kg cada" },
      { name: "Agachamento sumo com halter", sets: 3, reps: "12-15", restSeconds: 120, initialWeightKg: 13.5, notes: "12-15 kg" },
      { name: "Cadeira flexora", sets: 3, reps: "12-15", restSeconds: 90, initialWeightKg: 0, notes: "Ajustar" },
      { name: "Cadeira extensora", sets: 3, reps: "12-15", restSeconds: 90, initialWeightKg: 0, notes: "Ajustar" },
